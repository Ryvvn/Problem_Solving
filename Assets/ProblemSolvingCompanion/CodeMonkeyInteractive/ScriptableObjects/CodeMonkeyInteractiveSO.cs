...
namespace CodeMonkey.CSharpCourse.Interactive {
    ...
    public class CodeMonkeyInteractiveSO : ScriptableObject {
        ...
        [Serializable]
        public class ProblemSolvingFrameworkCheckboxState {
            public bool step1;
            public bool step2;
            public bool step3;
        }
        ...
        public ProblemSolvingFrameworkCheckboxState problemSolvingFrameworkCheckboxState;
        ...
        public static void ClearProblemSolvingFrameworkCheckboxState() {
            SetProblemSolvingFrameworkCheckboxState(new ProblemSolvingFrameworkCheckboxState {
                step1 = false,
                step2 = false,
                step3 = false,
            });
        ...
        public static void SetProblemSolvingFrameworkCheckboxState(ProblemSolvingFrameworkCheckboxState problemSolvingFrameworkCheckboxState) {
            CodeMonkeyInteractiveSO codeMonkeyInteractiveSO = GetCodeMonkeyInteractiveSO();
        ...
        public static ProblemSolvingFrameworkCheckboxState GetProblemSolvingFramworkCheckboxState() {
            CodeMonkeyInteractiveSO codeMonkeyInteractiveSO = GetCodeMonkeyInteractiveSO();
            return codeMonkeyInteractiveSO.problemSolvingFrameworkCheckboxState;
        }
        ...
        public static void CheckForUpdates(Action<string, string> onFoundUpdate) {
            ...
            string jsonData = JsonUtility.ToJson(new GenericActionJSONData {
                at = "problemsolvingcoursefreeversion",
            });
        ...
        public static void GetLatestMessage(Action<WebsiteLatestMessage> onResponse) {
            ...
            string jsonData = JsonUtility.ToJson(new GenericActionJSONData {
                at = "problemsolvingcoursefreelatestMessage",
            });
            byte[] bodyRaw = Encoding.UTF8.GetBytes(jsonData);
            unityWebRequest.uploadHandler = (UploadHandler)new UploadHandlerRaw(bodyRaw);
            unityWebRequest.downloadHandler = (DownloadHandler)new DownloadHandlerBuffer();
        ...
        public static void GetWebsiteDynamicMessage(Action<WebsiteDynamicMessage> onResponse) {
            ...
            string jsonData = JsonUtility.ToJson(new GenericActionJSONData {
                at = "problemsolvingcoursefreedynamicmessage",
            });
            byte[] bodyRaw = Encoding.UTF8.GetBytes(jsonData);
            unityWebRequest.uploadHandler = (UploadHandler)new UploadHandlerRaw(bodyRaw);
            unityWebRequest.downloadHandler = (DownloadHandler)new DownloadHandlerBuffer();
